...
ROOT = Path(__file__).resolve().parent.parent  # Go to app_restructured root
SERVER_PATH = ROOT / "infrastructure" / "mcp" / "gitlab_mcp.py"
...
server_params = StdioServerParameters(
    ...
    env={**os.environ, 
         "PYTHONUNBUFFERED": "1",
         "PYTHONPATH": str(ROOT)},  # Add the app_restructured root to Python path
